...
interface DeployFromGitHubDialogProps {
  open: boolean;
  onClose: () => void;
}

export function DeployFromGitHubDialog({ open, onClose }: DeployFromGitHubDialogProps) {
  ...
  const mutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      if (!res.ok) {
        ...
        throw new Error(error.message || 'Failed to deploy from GitHub');
      }
      return res.json();
    },
    onSuccess: () => {
